class VagasController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @vaga.update(vaga_params)
        format.html { redirect_to @vaga, notice: "Vaga was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to vagas_path, notice: "Vaga was successfully destroyed.", status: :see_other }
